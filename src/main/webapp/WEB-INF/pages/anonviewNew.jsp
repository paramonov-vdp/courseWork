                ...
                <div class="sider_container">
                    ...
                    <div class="carousel">
                        <c:forEach items="${products}" var = "products">
                            <div class="slide_item"><a class="fancybox" data-fancybox-group="group" href="img/mo.jpg"><img src="/img/111.jpg" alt="alt" /></a></div>
                        </c:forEach>
                    </div>
                </div>
                <hr>
                    ...
                    <div class="blog_item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 marg">
                                <h3><a href="//webdesign-master.ru" target="_blank">${products[a].description}</a></h3>
                                <a href="//webdesign-master.ru" target="_blank"><img src="111.jpg" alt="alt"></a>

                                <div class="float">${products[a].price} грн

                                </div>

                                <a  href="#callback" class="fancybox" class="d">
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="logo col-md-1">
                        <img src="1_Primary_logo_on_transparent_134x75.png" alt="">
                    </div>
...
<div class="hidden">
    <form id="callback" class="pop_form">
        <H2 align="center">Заказать товар</H2>
        <br>
        Ваше имя:
        </br>
        ...
        <div class="bn"><P><INPUT type="submit"   value= "Оформить!"></P></div>


        <div class="alert">Для доступа к корзине и накопления скидок авторизуйтесь на сайте!</div>
